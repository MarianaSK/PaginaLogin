...
<body>
    <div class="background--padrao">
        <div class="caixa--email--senha">
            ...
            <a href="./EsqueciSenha/esquecisenha.html"><div class="esqueci--senha">Esqueci minha senha</div></a>
            <a href="./Registre/registre.html"><div class="registre">Registre-se</div></a>
        </div>
    </div>
</body>
</html>